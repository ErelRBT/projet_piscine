...
-- Définition des paramètres de jeu de caractères
...
CREATE TABLE IF NOT EXISTS `agenda_agent` (
    ...
    CONSTRAINT fk_agent FOREIGN KEY (`ID_Agent`) REFERENCES `agent`(`ID_Agent`),
    CONSTRAINT fk_rdv FOREIGN KEY (`ID_RDV`) REFERENCES `rdv`(`ID_RDV`),
    CONSTRAINT fk_propriete FOREIGN KEY (`ID_Propriete`) REFERENCES `propriete`(`ID_Propriete`)
    ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `prop_photo` (
    ...
    KEY `ID_Propriete` (`ID_Propriete`),
    CONSTRAINT fk_propriete_photo FOREIGN KEY (`ID_Propriete`) REFERENCES `propriete`(`ID_Propriete`)
    ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Rétablissement des paramètres de jeu de caractères
